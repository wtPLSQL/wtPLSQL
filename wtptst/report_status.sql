...
@"../grb_linked_install_scripts/summarize_install_log.sql" "wtptst"
...
@"../grb_linked_install_scripts/list_invalids.sql" "'WTP'"
spool off
set termout on
set feedback on
...
@"../grb_linked_install_scripts/db_build_junit_report.sql" "'WTP'"
spool off
set termout on
set feedback on
...
@"../grb_linked_install_scripts/log_files_junit_report.sql" "wtptst"
spool off
set termout on
set feedback on
